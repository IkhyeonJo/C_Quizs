...
void EraseSnakeTail(char snake[2][3100]);
...
void DrawSnake(char snake[2][3100]);
void DrawFood(char food_coordinate[2]);
...
void EraseSnakeTail(char snake[2][3100]){
	...
	GotoXy(snake[0][i-1], snake[1][i-1]);
	printf(" ");
}
